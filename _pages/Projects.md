...
feature_row3:
  - image_path: /assets/images/Longnecked_Lightning.png
    ...
    excerpt: 'Powerplant selection, propeller analysis, thrust modelling, weight calculations throughout the flight profile, and landing gear and shock sizing of a novel conceptualized aircraft in response to an Ultimate-Class Air Racer AIAA RFP'
    btn_label: "Read More"
    btn_class: "btn--primary"
feature_row_END:
