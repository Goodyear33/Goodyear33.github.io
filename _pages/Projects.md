...
feature_row1:
  - image_path: /assets/images/ACS2.png
    ...
    excerpt: "A novel Active Suspension System (ACS) designed for the Carleton Planetary Rover Team utilizing actuators to sumiltaneously achieve an increased range of traversable terrain types and stability during locomotion. Have a look:"
    url: /ACS/
    btn_label: "Read More"
    btn_class: "btn--primary"
feature_row2:
